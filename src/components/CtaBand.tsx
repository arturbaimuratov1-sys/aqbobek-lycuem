...
export function CtaBand() {
  return (
    <section className="bg-white px-5 pb-20 md:px-8" aria-labelledby="cta-title">
      <Reveal className="mx-auto max-w-[1400px] bg-navy-900 px-6 py-12 md:px-14 md:py-16">
        <div className="grid items-center gap-8 lg:grid-cols-[1.4fr_1fr]">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-gold-500">
              2026–2027 оқу жылы
            </p>
            <h2 id="cta-title" className="mt-3 font-display text-3xl leading-tight text-balance text-white md:text-4xl">
              Грант негізінде оқу мүмкіндігін жіберіп алмаңыз
            </h2>
            <p className="mt-3 max-w-[60ch] text-[15.5px] leading-relaxed text-navy-100">
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex w-full justify-center bg-gold-500 px-7 py-3.5 text-[15px] font-semibold text-navy-950 transition-all duration-150 ease-out hover:bg-white active:scale-[0.97] lg:w-auto"
            >
              Өтініш қалдыру
            </a>
            <Link
